...
class WoWQuestionProvider(DynamicQuestionProvider):
    ...
    def generate_drop_instance(self):
        ...
        return self._question(
            ...
            drop["id"],
            category="Drops",
            answers=[inst.get("name"), inst.get("answers", {}).get("name")],
            difficulty="medium",
            source=item,
