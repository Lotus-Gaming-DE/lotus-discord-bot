...
from lotus_bot.bot import load_quiz_config
...
def test_load_quiz_config(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("lotus_bot.bot.QUIZ_CONFIG_PATH", str(cfg_file))
    monkeypatch.setattr("lotus_bot.bot.QUESTION_STATE_PATH", str(state_file))
