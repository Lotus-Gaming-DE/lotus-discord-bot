...
from lotusbot.cogs.quiz.duel import (
    QuizDuelGame,
    DuelInviteView,
    DuelConfig,
    DuelQuestionView,
...
async def test_game_run_dynamic(monkeypatch):
    ...
    monkeypatch.setattr("lotusbot.cogs.quiz.duel.DuelQuestionView", AutoView)
...
async def test_slash_duel_blocks_active_player(monkeypatch):
    ...
    from lotusbot.cogs.quiz.slash_commands import duel as duel_cmd
