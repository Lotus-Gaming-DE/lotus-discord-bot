...
logger = logging.getLogger(__name__)  # e.g. 'cogs.quiz.question_generator'
...
class QuestionGenerator:
    ...
    def generate_question_from_json(self, area):
        """
        Generiert eine Frage aus der JSON-Datei für die angegebene Area.
        ...
        # Bereits gestellte Fragen laden und filtern
        ...
        if not remaining:
            ...
            logger.info(
                f"[QuestionGenerator] All questions asked for area '{area}'. Resetting asked questions.")
    ...
    def generate_dynamic_wcr_question(self):
        """
        Generiert eine dynamische WCR-Frage basierend auf mehreren Fragetypen.
        Wählt einen Typ zufällig und versucht bis zu 10-mal, eine gültige Frage zu erzeugen.
        """
        types = [
    ...
    def generate_question_type_1(self):
        ...
        correct = [
            u['unit_name'] for u in talents if u['talent_name'] == pick['talent_name']
        ]
    ...
    # Weitere dynamische Fragetypen können hier hinzugefügt werden
